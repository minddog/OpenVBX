...
<div id="wrapper">
		...
		<div id="hd">
		<h1 id="openvbx-logo"><a href="<?php echo real_site_url(''); ?>" class="navigate-away"><span class="replace">OpenVBX</span></a></h1>
		</div><!-- #hd -->
				...
				<div class="yui-b">
					<div id="vbx-main">
						<div class="vbx-content-main">
							<p class="error-code">HTTP 401</p>
							<h1 class="error-title">The page your requested was not authorized.</h1>
							<p class="error-message">Please check the username and password you are entering.</p>
